...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    if name == "tdmpc":
        ...
        return ACTPolicy
    elif name == "actadajepa":
        from lerobot.policies.actadajepa.modeling_actadajepa import ACTAdaJEPAPolicy

        return ACTAdaJEPAPolicy
    elif name == "vqbet":
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    if policy_type == "tdmpc":
        ...
        return ACTAdaJEPAConfig(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, ACTAdaJEPAConfig):
        from lerobot.policies.actadajepa.processor_actadajepa import (
            make_actadajepa_pre_post_processors,
        )

        processors = make_actadajepa_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
